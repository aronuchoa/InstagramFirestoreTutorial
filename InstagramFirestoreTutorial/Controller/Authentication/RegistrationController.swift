...
//
//  Created by Aron Uchoa Bruno on 27/01/21.
//
...
class RegistrationController: UIViewController {
    ...
    @objc func handleSignUp() {
        ...
        AuthenticationService.registerUser(withCredential: credentials) { (error) in
            if let error = error {
    ...
    func configureUI() {
        ...
        stack.anchor(top: plusPhotoButton.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 18, paddingLeft: 32, paddingRight: 32)
